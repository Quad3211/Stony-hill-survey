    ...
    <div className="flex flex-col min-h-[calc(100vh-64px)]">
      ...
      <div className="relative bg-indigo-900 text-white">
        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:py-32 lg:px-8 flex flex-col items-center text-center">
          ...
          <p className="mt-6 max-w-2xl text-xl text-indigo-100 mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
            <Link
              to="/student/select"
              className="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-white hover:bg-indigo-50 md:py-4 md:text-lg transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
            ...
            <Link
              to="/admin/login"
              className="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              Admin Portal
            </Link>
          </div>
      ...
      <div className="py-16 bg-white overflow-hidden lg:py-24">
        <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="bg-gray-50 rounded-lg p-8 text-center hover:bg-gray-100 transition-colors">
